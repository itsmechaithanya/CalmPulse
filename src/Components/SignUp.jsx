  ...
  return (
    <div className='h-screen w-screen bg-[#7A4BC8] overflow-hidden relative'>
        ...
        <div className='flex flex-col justify-center mt-[3vh] items-center'>
            <button className='text-white bg-black px-8 flex justify-center items-center py-5 rounded-full gap-3 shadow'>
        ...
        <div className='flex justify-end mt-2 mr-5'>
          <Link to="/login">
            <button className='bg-black text-white px-16 py-5 rounded-full shadow'>
              Log In
            </button>
          </Link>
        </div>
