        ...
        <div className='h-[80vh] w-[90vw] bg-[#9676cd] rounded-2xl'>
          ...
          <div className='flex justify-between pt-[5vh] px-[9vw]'>
            <button
              ...
              className={`${Yes ? "bg-[#309b47] font-medium" : "bg-[#7A4BC8]"} px-8 py-3 rounded-full text-white font-medium text-2xl`}
            >
              Yes
            </button>
            <button
              onClick={() => handleQuestion(index, 'No')}
              className={`${No ? "bg-[#cd3b3b] font-medium" : "bg-[#7A4BC8]"} px-8 py-3 rounded-full text-white text-2xl`}
            >
              No
            </button>
          </div>
